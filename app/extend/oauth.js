...
module.exports = () => {
  ...
  class Model {
     ...
     * @return {String} - A `String` to be used as access token.
     */
     ...
     * @return {String} - A `String` to be used as refresh token.
     */
     ...
     * @return {Object} token - The return value.
     * @return {String} token.accessToken - The access token passed to `getAccessToken()`.
     * @return {Date} token.accessTokenExpiresAt - The expiry time of the access token.
     * @return {String} [token.scope] - The authorized scope of the access token.
     * @return {Object} token.client - The client associated with the access token.
     * @return {String} token.client.id - A unique string identifying the client.
     * @return {Object} token.user - The user associated with the access token.
     */
     ...
     * @return {Object} token - The return value.
     * @return {String} token.refreshToken - The refresh token passed to `getRefreshToken()`.
     * @return {Date} [token.refreshTokenExpiresAt] - The expiry time of the refresh token.
     * @return {String} [token.scope] - The authorized scope of the refresh token.
     * @return {Object} token.client - The client associated with the refresh token.
     * @return {String} token.client.id - A unique string identifying the client.
     * @return {Object} token.user - The user associated with the refresh token.
     */
     ...
     * @return {Object} code - The return value.
     * @return {String} code.code - The authorization code passed to `getAuthorizationCode()`.
     * @return {Date} code.expiresAt - The expiry time of the authorization code.
     * @return {String} [code.redirectUri] - The redirect URI of the authorization code.
     * @return {String} [code.scope] - The authorized scope of the authorization code.
     * @return {Object} code.client - The client associated with the authorization code.
     * @return {String} code.client.id - A unique string identifying the client.
     * @return {Object} code.user - The user associated with the authorization code.
     */
    async getAuthorizationCode(authorizationCode) {
      ...
      const scope = JSON.parse(oauthAuthCode.scopes);
     ...
     * @return {Object} client - The return value.
     * @return {String} client.id - A unique string identifying the client.
     * @return {Array<String>} [client.redirectUris] - Redirect URIs allowed for the client. Required for the `authorization_code` grant.
     * @return {Array<String>} client.grants - Grant types allowed for the client.
     ...
     * @return {Object} An Object representing the user, or a falsy value if the client does not have an associated user.
     ...
     * @return {Object} token - The return value.
     * @return {String} token.accessToken - The access token passed to `saveToken()`.
     * @return {Date} token.accessTokenExpiresAt - The expiry time of the access token.
     * @return {String} token.refreshToken - The refresh token passed to saveToken().
     * @return {Date} token.refreshTokenExpiresAt - The expiry time of the refresh token.
     * @return {String} [token.scope] - The authorized scope of the access token.
     * @return {Object} token.client - The client associated with the access token.
     * @return {String} token.client.id - A unique string identifying the client.
     ...
     * @return {Object} code - The return value.
     * @return {String} code.authorizationCode - The authorization code passed to `saveAuthorizationCode()`.
     * @return {Data} code.expiresAt - The expiry time of the authorization code.
     * @return {String} code.redirectUri - The redirect URI associated with the authorization code.
     * @return {String} [code.scope] - The authorized scope of the authorization code.
     * @return {Object} code.client - The client associated with the authorization code.
     * @return {String} code.client.id - A unique string identifying the client.
     * @return {Object} code.user - The user associated with the authorization code.
    ...
    async saveAuthorizationCode(code, client, user) {
      code.scope = await this.validateScope(user, client, code.scope);

      await this.ctx.model.OauthAuthCode.create({
        id: code.authorizationCode,
        user_id: user.id,
        client_id: client.id,
        scopes: JSON.stringify(code.scope),
        revoked: false,
     ...
     * @return {Boolean} Return `true` if the revocation was successful or `false` if the refresh token could not be found.
     */
     ...
     * @return {Boolean} Return `true` if the revocation was successful or `false` if the authorization code could not be found.
     */
    ...
    async validateScope(user, client, scope) {
      ...
      const scopes = scope ? scope.split(' ') : this.config.oAuth2Server.defaultScope;
      const validScopes = this.config.oAuth2Server.scopes.map(scope => scope.id);
