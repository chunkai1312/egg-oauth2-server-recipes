...
module.exports = {
  ...
  'password.password': 'Passwords must be at least eight characters and match the confirmation.',
  'password.reset': 'Your password has been reset!',
  'password.sent': 'We have e-mailed your password reset link!',
  'password.token': 'This password reset token is invalid.',
  'password.user': "We can't find a user with that e-mail address.",
